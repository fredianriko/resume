          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            {items.map((item) => (
              <a
                ...
                className="w-full rounded-lg border border-slate-300 px-6 py-3 font-medium text-slate-700 transition hover:border-blue-500 hover:text-blue-600 sm:w-auto dark:border-slate-700 dark:text-slate-200 dark:hover:border-blue-500 dark:hover:text-blue-400"
              >
                {item.label}
              </a>
            ))}
